 ...
 * @desc
 */
public class NavigationListBean extends BaseEntity {
    ...
    private int cid;
    private String name;
    private List<FeedArticleDataBean> articles;
    ...
    public List<FeedArticleDataBean> getArticles() {
        return articles;
    }

    public void setArticles(List<FeedArticleDataBean> articles) {
